public class MembershipTree {
    ...
    public MembershipTree(String memberId, int borrowLimit) {
    ...
    public static String classifyGeneration(MembershipTree member) {
    ...
    public static int getTotalBooksBorrowed(MembershipTree[] members) {
        int total = 0;

        for (MembershipTree member : members) {
    ...
    public static void main(String[] args) {
        MembershipTree member =
                new MembershipTree("STU1", 3);
...
class StudentMember extends MembershipTree {
...
class FacultyMember extends MembershipTree {
